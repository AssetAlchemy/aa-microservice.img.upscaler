...
class Config:
    # Gral
    source = os.getenv(key="SOURCE", default="aa-microservice.img.upscaler")
    ...
    queue_name = os.getenv(key="RABBITMQ_QUEUE_RECEIVE", default="assets.img.upscaler.1")
    binding_key = os.getenv(key="RABBITMQ_BINDING_KEY", default="assets.img.upscaler.1")
